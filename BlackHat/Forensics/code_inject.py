...
sys.path.append("/Users/Cipherpunk/Downloads/volatility-2.3.1")
...
for process in p.calculate():
    if str(process.ImageFileName) == "calc.exe":
        ...
        print("[*] Seeking physical offsets... please wait")
        ...
        for page in pages:
            ...
            if page[0] <= equals_button and equals_button < ((page[0] + page[1])-7):
                print("[*] Found trampoline target at: 0x%08x" % (physical))

                # calculate virtual offset
                v_offset = equals_button - page[0]
                # calculate physical offset
                trampoline_offset = physical + v_offset
                print("[*] Found trampoline target at: 0x%08x" % (trampoline_offset))
